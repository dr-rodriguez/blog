...
date: 2016-10-19
image: /assets/img/posts/2016/20161019/25735618.jpg
...
![](/assets/img/posts/2016/20161019/25735618.jpg){: width="500" .w-50 .left}

**Death's End** , by Liu Cixin and translated by Ken Liu, is the third and final installment of the **Remembrance of Earth's Past** series. It chronicles the events following [The Dark Forest]({% post_url 2015/2015-09-06-book-review-the-dark-forest-by-cixin-liu %}) and focuses on humanity's place in the universe. There is a lot of interesting science/science fiction concepts presented in this hard sci-fi novel, which keep you thinking on it for days on end.  
  
Read on for my review, but bear in mind that as the third in the series there may be spoilers for [The Three-Body Problem]({% post_url 2015/2015-07-12-book-review-the-three-body-problem-by-liu-cixin %}) and [The Dark Forest]({% post_url 2015/2015-09-06-book-review-the-dark-forest-by-cixin-liu %}).  
...
Although the plot starts of a bit slow, it quickly ramps up as conflicts flare up again and the threat of dark forest strikes becomes imminent. My favorite part of Liu Cixin's books has been trying to untangle the secrets of the main plot. In [The Three-Body Problem]({% post_url 2015/2015-07-12-book-review-the-three-body-problem-by-liu-cixin %}), it was figuring out how the mystery of the events surrounding the particle physicists and the Three-Body game. In [The Dark Forest]({% post_url 2015/2015-09-06-book-review-the-dark-forest-by-cixin-liu %}), it was figuring out the Luo Ji's Wallfacer plan. In this book, one of the main mysteries revolves around a set of three cryptic fairy tales.  
