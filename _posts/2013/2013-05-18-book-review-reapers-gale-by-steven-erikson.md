...
For long series like this one, it's sometimes difficult to split the thoughts into each individual book. However, now that I think about it I realize that the [Malazan](/blog/tags/malazan/) series tends to have a unique and separate focus for each book, which greatly helps to keep them apart:  
